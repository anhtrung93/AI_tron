...
////
////void test_copy(){
////	const char TEST_CP_FILE[] = "E:\\Dropbox\\Projects\\GAMELOFT_AI_2015\\MyCode\\copyTest.txt";
////	freopen(TEST_CP_FILE, "r", stdin);
////	int * board = new int[MAP_SIZE * MAP_SIZE];
////	for (int idRow = 0; idRow < MAP_SIZE; ++idRow){
////		for (int idCol = 0; idCol < MAP_SIZE; ++idCol){
...
////		}
////	}
////	cout << "isSpecialBoard: " << isSpecialBoard(board) << endl;
////	cout << "isPalinBoard: " << isPalinBoard(board, Position(0, 0), Position(10, 10)) << endl;
////}
//
//void testTreeOfChamber(){
//	Position myPos, enemyPos;
//	const char TEST_CP_FILE[] = "E:\\Dropbox\\Projects\\GAMELOFT_AI_2015\\MyCode\\boards.txt";
//	freopen(TEST_CP_FILE, "r", stdin);
//	int numTest;
//	cin >> numTest;
//	int * board = new int[MAP_SIZE * MAP_SIZE];
//	for (int idTest = 0; idTest < 1; ++idTest){
//		int minimaxValue = 0, treeVonoroiValue = 0;
//
//		for (int idRow = 0; idRow < MAP_SIZE; ++idRow){
//			for (int idCol = 0; idCol < MAP_SIZE; ++idCol){
//				cin >> board[CONVERT_COORD(idRow, idCol)];
//				if (board[CONVERT_COORD(idRow, idCol)] == 1){
//					myPos.x = idRow; myPos.y = idCol;
//				}
//				else if (board[CONVERT_COORD(idRow, idCol)] == 3){
//					enemyPos.x = idRow; enemyPos.y = idCol;
//				}
//			}
//		}
//
//		cin >> treeVonoroiValue;
//		cin >> minimaxValue;
//
//		int tmp = heurEstTreeChamber(board, myPos, enemyPos, true);
//		cout << idTest << " " << tmp << " " << minimaxValue << " " << treeVonoroiValue << " " << heurEstTreeVonoroi(board, myPos, enemyPos, true) << endl;
//	}
//}
//
//void testHeurForNonSplitSpeed(){
//	int count = 0;
//	const char UPPER_LONGEST_TEST[] = "E:\\Dropbox\\Projects\\GAMELOFT_AI_2015\\MyCode\\boards.txt";
//	ifstream is(UPPER_LONGEST_TEST, ifstream::in);
...
//
//				if (count == 0){
//					heurEstVonoroi(board, myPos, enemyPos, true);
//				}
//				else if (count == 1){
//					heurEstTreeVonoroi(board, myPos, enemyPos, true);
//				}
//				else {
//					heurEstTreeChamber(board, myPos, enemyPos, true);
//				}
//			}
//			is.seekg(0, is.beg);
//		}		
//		if (count == 0){
//			cout << "time heurEstVonoroi: " << (getCurTime() - startTime) << endl;
//		}
//		else if (count == 1){
//			cout << "time heurEstTreeVonoroi: " << (getCurTime() - startTime) << endl;
//		}
//		else {
//			cout << "time heurEstTreeChamber: " << (getCurTime() - startTime) << endl;
//		}
//	}
//	
//}
